export const descArrGreenlabs: descArr[] = [
  {
    descTitle: "[자재 플랫폼 서비스 마이그레이션]",
  ...
  {
    descTitle: "[이미지 기반 병해충 진단 (병해충 처방 v1.0.0)]",
  ...
  {
    descTitle: "[병해충 진단 농약 처방 기능 추가 (병해충 처방 v2.0.0)]",
  ...
  {
    descTitle: "[농약사 찾기 (시공사/농약사 찾기 v2.0.0)]",
  ...
  {
    descTitle: "[내 주변 병해충 진단 (병해충 처방 v3.0.0)]",
  ...
  {
    descTitle: "[진단 결과 및 상세 결과 고도화 (병해충 처방 v3.2.0)]",
