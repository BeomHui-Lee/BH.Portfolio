...
const iconSrcArr: iconSrcArr[] = [
  ...
  { src: "/icons/NextJS-Light.svg", className: "", x: "2", top: "300px", text: "NextJS" },
  { src: "/icons/React-Light.svg", className: "", x: "2", top: "400px", text: "React" },
  { src: "/icons/VueJS-Light.svg", className: "", x: "2", top: "500px", text: "VueJS" },
